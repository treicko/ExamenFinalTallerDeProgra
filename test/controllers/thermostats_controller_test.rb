...
class ThermostatsControllerTest < ActionController::TestCase
  ...
  test "should create thermostat" do
    assert_difference('Thermostat.count') do
      post :create, thermostat: { location_id: @thermostat.location_id, place: @thermostat.place, serial_number: @thermostat.serial_number }
    end
  ...
  test "should update thermostat" do
    patch :update, id: @thermostat, thermostat: { location_id: @thermostat.location_id, place: @thermostat.place, serial_number: @thermostat.serial_number }
    assert_redirected_to thermostat_path(assigns(:thermostat))
  end
